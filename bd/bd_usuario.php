...
function cadastraUsuario($nome,$senha,$email,$perfil,$status,$data, $cep, $logradouro, $bairro, $cidade, $estado){
    ...
    $conexao = conecta_bd();
    $query = "Insert Into usuario(nome,senha,email,perfil,status,data,cep,logradouro,bairro,cidade,estado) 
    values('$nome','$senha','$email','$perfil','$status','$data','$cep','$logradouro','$bairro','$cidade','$estado')";
